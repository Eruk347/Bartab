#pragma checksum "C:\Users\xkrk\Documents\GitHub\Bartab\Bartab\Bartab\Views\UserContent.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "C7B2127EACF74BFD2B70AA85FBBDD790"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Bartab
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        {
            private global::Data.VareItem dataRoot;
            ...
            {
                 global::Data.VareItem data = args.NewValue as global::Data.VareItem;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::Data.VareItem was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::Data.VareItem);
                ...
                this.Update_((global::Data.VareItem) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::Data.VareItem newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::Data.VareItem obj, int phase)
            {
                if (obj != null)
                {
            ...
            IUserContent_Bindings
        {
            ...
            private void Update_UCVM(global::ViewModel.UserContentViewModel obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_UCVM_vareItem(obj.vareItem, phase);
                        this.Update_UCVM_IndkobListe(obj.IndkobListe, phase);
                        this.Update_UCVM_brugere(obj.brugere, phase);
                    }
                }
            }
            private void Update_UCVM_vareItem(global::System.Collections.ObjectModel.ObservableCollection<global::Data.VareItem> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_UCVM_brugere(global::System.Collections.ObjectModel.ObservableCollection<global::Data.User> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 13:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::Data.VareItem) element13.DataContext);
